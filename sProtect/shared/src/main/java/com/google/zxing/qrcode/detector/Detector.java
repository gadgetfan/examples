...
/**
 * $C
 * - remove perspective transformation (save time)
 * - remove BitMatrix fill (no need qr-code data translation),
 */
public class Detector {
  ...
  protected DetectorResult processFinderPatternInfo(FinderPatternInfo info)
   ...
   /*PerspectiveTransform transform =
    ...
    BitMatrix bits = new BitMatrix(dimension);//$C sampleGrid(image, transform, dimension);
    ...
    return new DetectorResult(dimension, points);//$C
  }
  ...
  public static PerspectiveTransform createTransform(ResultPoint topLeft,
    ...
    return PerspectiveTransform.quadrilateralToQuadrilateral(
        //$C changed places of arguments 1-8 <-> 9-16
        3.5f,
        3.5f,
        dimMinusThree,
        3.5f,
