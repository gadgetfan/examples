...
public class ImagePreloader {
    ...
    public static void load(String url, ImageLoadHandler loadHandler) {
        ...
        if (false) { //prevent error http://stackoverflow.com/questions/2923564/uncaught-error-index-size-err
            //TODO: check, that owing to this branch off no double links in dimensionCache are created
            //TODO: remove dimensionCache
            if (loadHandler != null) {
        ...
        if (loadingArea == null) {
            ...
            Event.setEventListener(loadingArea, new EventListener() {
                public void onBrowserEvent(Event event) {
                    ...
                    //need for IE9: don't delete loaded images
